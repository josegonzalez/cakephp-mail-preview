...
MailPreview loves to welcome your contributions. There are several ways to help out:
...
* Contribute to the [documentation](https://github.com/josegonzalez/cakephp-mail-preview/tree/gh-pages)
...
MailPreview tests requires [PHPUnit](http://www.phpunit.de/manual/current/en/installation.html)
4.1 or higher. To run the testcases locally use the following command:
...
* [Bug tracker](https://github.com/josegonzalez/cakephp-mail-preview/issues)
